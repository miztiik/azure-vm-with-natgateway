...
// Crate NAT Gateway
module r_natGw 'create_nat_gateway.bicep' = if (vnetParams.deployNatGateway) {
  scope: resourceGroup(rgName)
  name: '${vnetParams.natGwParams.natGwNamePrefix}_${deploymentParams.global_uniqueness}_NatG'
  params: {
    deploymentParams:deploymentParams
    natGwParams:vnetParams.natGwParams
    tags: tags
  }
  dependsOn: [
    r_vnet
